...
\input{./1-remerciements/1-remerciements.tex} % Mettre ici les remerciements

\tableofcontents			% Table des matières

\addcontentsline{toc}{chapter}{Table des mati\`eres}
\input{./2-intro/2-intro.tex}
\input{./3-l_entreprise/3-presentation.tex}
\input{./4-projet/4-projet.tex}
\input{./5-codage/5-codage.tex}
